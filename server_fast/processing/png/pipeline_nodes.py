import numpy as np
from processing.png.filters.noise_reduction.nl_means import NlMeansFilter
from processing.png.filters.noise_reduction.bilateral import BilateralFilter
from processing.png.filters.noise_reduction.gaussian import GaussianFilter
from processing.png.filters.mask_extraction.mass_cleaning import MassCleaningFilter
from processing.png.filters.mask_extraction.mask_clipping import MaskClippingFilter
from processing.png.filters.mask_extraction.morph_connect import MorphConnectFilter
from processing.png.filters.mask_extraction.morph_open import MorphOpenFilter
from processing.png.filters.illumination_contrast.clahe import CLAHEFilter
from processing.png.filters.illumination_contrast.gamma import GammaFilter
from processing.png.filters.illumination_contrast.logarithmic import LogarithmicFilter
from processing.png.filters.illumination_contrast.min_max import MinMaxFilter
from processing.png.filters.illumination_contrast.fuzzy_logic import FuzzyLogicFilter
from processing.png.filters.illumination_contrast.local_statistical import LocalStatisticalFilter
from processing.png.filters.illumination_contrast.global_hist_eq import GlobalHistEqFilter
from processing.png.filters.edge_detection.canny_filter import CannyEdgesFilter
from processing.png.filters.edge_detection.otsu_threshold import OtsuThresholdFilter
from processing.png.filters.edge_detection.multi_otsu_threshold import MultiOtsuThresholdFilter
from processing.png.filters.detail_enhancement.laplacian import LaplacianFilter
from processing.png.filters.detail_enhancement.unsharp_mask import UnsharpMaskFilter
from processing.png.filters.detail_enhancement.tophat_morf import TopHatMorfFilter
from processing.png.filters.operations.bitwise_and import LogicAndFilter
from processing.png.filters.operations.bitwise_or import LogicOrFilter
from processing.png.filters.operations.invert_not import InvertNotFilter

from processing.png.filters.advanced_segmentation.region_growing import RegionGrowingFilter
from processing.png.filters.advanced_segmentation.skull_stripping import SkullStrippingFilter
from processing.png.filters.advanced_segmentation.watershed import WatershedFilter
#Filtros
FILTERS_REGISTRY = {
    #noise_reduction
